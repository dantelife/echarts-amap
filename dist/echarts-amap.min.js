  ...
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : 'object' == typeof exports
        ? (exports.amap = e(require('echarts')))
        : ((t.echarts = t.echarts || {}), (t.echarts.amap = e(t.echarts)));
})(this, function(t) {
  return (function(t) {
    function e(n) {
    ...
    function(t, e, o) {
      ...
      var a = o(0);
      (n.prototype.dimensions = ['lng', 'lat']),
      ...
      (n.dimensions = n.prototype.dimensions),
          ...
          t.eachComponent('amap', function(t) {
            ...
            if (!t.__amap) {
              ...
              p &&
                ...
                p.classList.add('ec-extension-amap'),
                r.appendChild(p);
              var s = t.get() || {};
            ...
            var m = c.getZoom(),
              u = c.getCenter();
            (o = new n(c, e)),
              o.setMapOffset(t.__mapOffset || [0, 0]),
              o.setZoom(m),
              o.setCenter([u.lng, u.lat]),
    ...
    function(t, e, o) {
      function n(t, e, o) {
        ...
        return (
          ...
          (r = function() {
            n
              ? (a = arguments)
              : (t.apply(o, arguments), setTimeout(i, e), (n = !0));
          })
        );
      }
      var a = o(0);
      t.exports = o(0).extendComponentView({
        ...
        render: function(t, e, o) {
          function r() {
            p || o.dispatchAction({ type: 'amapRoam' });
          }
          function i(t) {
            ...
            m = function(e) {
              if (!p) {
                var n = c.parentNode.parentNode.parentNode,
                  a = [
                    -parseInt(n.style.left, 10) || 0,
                    -parseInt(n.style.top, 10) || 0,
                  ];
                (c.style.left = a[0] + 'px'),
                  (c.style.top = a[1] + 'px'),
                  f.setMapOffset(a),
                  (t.__mapOffset = a),
                  o.dispatchAction({ type: 'amapRoam' });
              }
            },
            u = n(i, 300, s);
          s.off('movestart', this._oldMoveHandler),
            s.off('zoomend', this._oldZoomEndHandler),
            s.off('moveend', this._oldZoomEndHandler),
            s.off('complete', this._oldZoomEndHandler),
            t.get('resizeEnable') && s.off('resize', this._oldResizeHandler),
            s.on('movestart', m),
            s.on('zoomend', r),
            s.on('moveend', r),
            s.on('complete', r),
            t.get('resizeEnable') && s.on('resize', u),
            (this._oldMoveHandler = m),
            (this._oldZoomEndHandler = r),
            (this._oldResizeHandler = u),
            (p = !1);
        },
      });
    },
    function(t, e, o) {
      o(0).registerCoordinateSystem('amap', o(1)),
        o(2),
        o(3),
        o(0).registerAction(
          { type: 'amapRoam', event: 'amapRoam', update: 'updateLayout' },
          function(t, e) {
            e.eachComponent('amap', function(t) {
              var e = t.getAMap(),
                o = e.getCenter();
              t.setCenterAndZoom([o.lng, o.lat], e.getZoom()),
                amapModel.setRotation(e.getRotation()),
                amapModel.setPitch(e.getPitch());
            });
          },
        ),
